...
map_data_mmx_to_mmcc_forecast = {
    ...
    MmccForecastColumns.AIR_TEMPERATURE: lambda df: df[MmxColumns.AIR_TEMPERATURE],
    MmccForecastColumns.HUMIDITY: lambda df: df[MmxColumns.HUMIDITY],
    MmccForecastColumns.WIND_SPEED: lambda df: df[MmxColumns.WIND_SPEED],
    MmccForecastColumns.WIND_DIRECTION: lambda df: df[MmxColumns.WIND_DIRECTION],
    MmccForecastColumns.PRECIPITATION_CODE: lambda df: df[MmxColumns.PRECIPITATION_CODE],
    MmccForecastColumns.PRECIPITATION_INTENSITY: lambda df: df[MmxColumns.PRECIPITATION_INTENSITY],
    MmccForecastColumns.DEW_POINT: lambda df: df[MmxColumns.DEW_POINT],
    MmccForecastColumns.PRESSURE: lambda df: df[MmxColumns.PRESSURE],
    MmccForecastColumns.VISIBILITY: lambda df: df[MmxColumns.VISIBILITY],
    MmccForecastColumns.P_WEATHER: lambda df: df[MmxColumns.P_WEATHER],
