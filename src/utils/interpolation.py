...
from constants import MmxColumns, mmx_id_columns
...
def create_patterns_list(df_mmx, max_gap=pd.Timedelta('2h'), min_length=pd.Timedelta('12h')):
...
def interpolate_mmx(df_mmx, freq='30min'):
    ...
    def interpolate(df):
        ...
        df_result = df_result.merge(df_add, how='outer',
                                    on=[MmxColumns.STATION_ID, 'interpol', MmxColumns.DATE_TIME_LOCAL], left_index=True,
